                ...
                <div x-show="activeTab === 'tab-recent'" x-transition:enter="transition-all duration-500 easy-in-out"
                    ...
                    <div class="swiper-wrapper">
                        <div class="card swiper-slide w-56 shrink-0 p-3 pt-4">
                            <div class="flex items-center justify-between" x-data="{showModal:false}">
                                ...
                                <template x-teleport="#x-teleport-target">
                                    <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5" x-show="showModal" role="dialog" @keydown.window.escape="showModal = false">
                                        ...
                                        <div class="px-4 py-4 sm:px-5">
                                            <p>
                                                Masukan penjualan berapa bulan kebelakang, untuk menjadi perhitungan sistem
                                            </p>
                                            <div class="mt-4 space-y-4">
                                                <form action="/dashboard" method="post">
                                                    @csrf
                                                    <label class="block mb-2">
                                                        <span>Total bulan kebelakang :</span>
                                                        <select class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent" name="total_bulan">
                                                    ...
                                                    <label class="block mb-2">
                                                        @if(isset($hasAveragePenjualan))
                                                            <span>Tanggal Merah {{$bulan}} bulan kebelakang :</span>
                                                            <span>
                                                                <input
                                                                    class="form-input w-full rounded-lg mt-1.5 border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                                    placeholder="Tanggal Merah {{$bulan}} bulan kebelakang"
                                                                    type="text"
                                                                    name="tanggal_merah"
                                                                />
                                                            </span>
                                                        @else
                                                            <span>Tanggal Merah bulan kebelakang :</span>
                                                            <span>
                                                                <input
                                                                    class="form-input w-full rounded-lg mt-1.5 border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                                    placeholder="Tanggal Merah bulan kebelakang"
                                                                    type="text"
                                                                    name="tanggal_merah"
                                                                />
                                                            </span>
                                                    ...
                                                    <label class="block mb-2">
                                                        @if(isset($hasAveragePenjualan))
                                                            <span>Tanggal Merah Sisa Bulan {{$month}}:</span>
                                                            <span>
                                                                <input
                                                                    class="form-input w-full rounded-lg mt-1.5 border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                                    placeholder="Tanggal Merah Sisa Bulan {{$month}}"
                                                                    type="text"
                                                                    name="tanggal_merah_sisa_bulan"
                                                                />
                                                            </span>
                                                        @else
                                                            <span>Tanggal Merah Sisa Bulan :</span>
                                                            <span>
                                                                <input
                                                                    class="form-input w-full rounded-lg mt-1.5 border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                                    placeholder="Tanggal Merah Sisa Bulan "
                                                                    type="text"
                                                                    name="tanggal_merah_sisa_bulan"
                                                                />
                                                            </span>
                                                    ...
                                                    <label class="block mb-2">
                                                        <span>Buffer stock dalam persen :</span>
                                                        <input
                                                            class="form-input w-full rounded-lg mt-1.5 border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                    ...
                                                    <div class="space-x-2 text-right mt-2">
                                                        <button
                                                            @click="showModal = false"
            ...
            <div class="col-span-12">
                ...
                <div class="card mt-3">
                    <div class="is-scrollbar-hidden min-w-full overflow-x-auto p-3">
                        <table class="is-hoverable w-full text-left" id="myTable1">
                            <thead>
                                <tr>
                                    <!-- <th
                                    ...
                                    @if(isset($hasAveragePenjualan))
                                        ...
                                        <th
                                            class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                                            Buffer Stock {{$buffer_stock}}% - Stock
                                        </th>
                                        <th
                                            class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                                            Rata - rata Harian
                            ...
                            <tbody>
                                @foreach ($getDataRegs as $getDataReg)
                                <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        {{$getDataReg -> HARI}} Hari
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        {{$getDataReg -> STOCK_QTY}}
                                    </td>
                                    @if(isset($getDataReg->penjualan) || isset($getDataReg->average_penjualan)
                                    || isset($getDataReg->value_buffer_stock)|| isset($getDataReg->buffer_stock_minus_stock)
                                    || isset($getDataReg->average_harian)|| isset($getDataReg->total_pembelian_plus_po)
                                    )
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            {{$getDataReg -> penjualan}}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            {{$getDataReg -> average_penjualan}}
                                        </td>
                                        <!-- <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            tes
                                        </td>
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            {{$getDataReg -> value_buffer_stock}}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            {{$getDataReg -> buffer_stock_minus_stock}}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            {{$getDataReg -> average_harian}}
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
    ...
    <script>
        $(document).ready(function () {
            $('#myTable1').DataTable({
                processing: true,
                lengthMenu: [
                    [10, 25, 50, -1],        // pilihan jumlah baris yang tampil
                    [10, 25, 50, "All"]      // label untuk pilihan di dropdown
                ],
            });
        });
    </script>
